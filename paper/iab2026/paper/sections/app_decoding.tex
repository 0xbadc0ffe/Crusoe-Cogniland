...
MLP probe to predict the category at each bin, against a shuffled-label null.
Figure~\ref{fig:results_belief}a reports the rocky-against-lakes accuracy on
the $266$ decisive test maps. The gap between the two probes measures how
non-linear the code is.
...
\label{eq:add}
\end{equation}
where a positive edit pushes toward rocky, a negative edit toward lakes, and $\alpha$ is the dose
