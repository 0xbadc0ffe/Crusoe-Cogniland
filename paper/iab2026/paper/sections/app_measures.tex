...
only costlier; on lakes and rocky maps this is not enforced, and the timeout
column of Table~\ref{tab:clamp_all} carries the cost. Every steered episode is paired with the unsteered agent on
