...
Activation steering changes what a model does by adding a vector to its hidden
...
We ask what a steering edit aimed at a behavior does to the belief. The
question is hard to answer in a language model, where beliefs have no ground
truth. We therefore build Cogniland, a procedurally generated navigation task
