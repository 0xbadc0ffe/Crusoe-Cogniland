...
change the behavior, for instance to suppress \textsc{mine} so that the
agent walks around mountains instead. Ideally the intervention $\mathcal{I}$ leaves the belief,
and hence the final decision $D$, untouched. We measure \emph{belief corruption} as the change
in $\hat b$ and in the final decision $D$ that $\mathcal{I}$ causes.
