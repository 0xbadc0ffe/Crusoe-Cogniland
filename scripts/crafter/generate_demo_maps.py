#!/usr/bin/env python3
"""Generate the 12 curated demo maps used by ``scripts/crafter/play_cogniland.py``.
...
Usage
-----
    python scripts/crafter/generate_demo_maps.py
    python scripts/crafter/generate_demo_maps.py --tile-px 6 --size 64
"""
...
# allow `python scripts/crafter/generate_demo_maps.py` from the repo root without install
