...
The sibling of ``scripts/bridge_tunnel/bridge_tunnel_traj_grid.py`` (the PPO renderer): for each of
...
generator, proven bit-for-bit in tests/test_bridge_tunnel_jax_parity.py).
    ...
    python scripts/bridge_tunnel/viz_dreamer_bridge_tunnel_traj.py \\
