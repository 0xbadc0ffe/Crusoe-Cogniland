"""Egocentric tile-id minimap renderer for the pure-JAX zebra_nav env.

A bit-for-bit port of ``ZebraNavEnv._make_obs`` / ``_egocentric_crop``:
...
def build_obs(state: EnvState, params: EnvParams) -> dict:
    """Dict observation matching the zebra_nav convention.
