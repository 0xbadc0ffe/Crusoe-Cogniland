...
class BridgeTunnelEnv(gym.Env):
    """Crafter-style 32×32 bridge_tunnel-stripe navigation env.
    ...
    def reset(self, *, seed: int | None = None, options: dict | None = None
        ...
        if self._fixed_record is not None:
            ...
            self._record = generate_bridge_tunnel_map(
...
__all__ = ["BridgeTunnelEnv", "NUM_ACTIONS", "A_UP", "A_DOWN", "A_LEFT", "A_RIGHT",
