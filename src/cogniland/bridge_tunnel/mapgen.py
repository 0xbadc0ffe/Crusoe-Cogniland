"""Procedural map generation for bridge_tunnel (natural-only).
...
vocabulary. ``generate_bridge_tunnel_map(orientation=...)`` raises ``ValueError`` for
...
def generate_bridge_tunnel_map(
    size: int = 32,
    seed: int = 0,
