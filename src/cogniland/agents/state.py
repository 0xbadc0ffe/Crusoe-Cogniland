...
from cogniland.agents.world_models.base import WorldModelParams, WorldModelState
from cogniland.agents.commons.replay_buffer import ReplayBufferState
...
class RuntimeState:
    ...
    Attributes:
        ...
        current_num_actions: Number of actions in current environment [scalar]
                            - Used for action masking when environments have different action spaces
                            - Updated via agent.set_environment() when switching environments
    ...
    current_num_actions: jnp.ndarray  # Number of actions in current environment
    current_task_id: Optional[jnp.ndarray] = None  # Task index (set via set_environment)
...
class AgentState:
    ...
    Usage examples:
        ...
        # World model agent (DreamerV3)
        from cogniland.agents.world_models.dreamerv3 import DreamerV3TrainState, DreamerV3Params
