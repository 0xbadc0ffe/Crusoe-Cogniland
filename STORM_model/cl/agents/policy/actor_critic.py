...
from cl.agents.commons.returns import lambda_return
from cl.agents.commons.normalizers import update_normalizer, get_normalizer_stats
from cl.agents.world_models.base import WorldModel, WorldModelParams, WorldModelState
from cl.agents.policy.base import Policy
...
def imag_loss(
    ...
    value_dist = policy.apply_critic(policy_params.critic, features_flat, training=False)
    ...
    actor_dist = policy.apply_actor(policy_params.actor, features_flat, training=False)
