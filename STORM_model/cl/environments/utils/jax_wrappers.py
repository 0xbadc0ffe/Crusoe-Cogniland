# Source: https://github.com/MichaelTMatthews/Craftax_Baselines/blob/main/wrappers.py
...
class OptimisticResetVecEnvWrapper(GymnaxWrapper):
    ...
    def __init__(self, env, num_envs: int, reset_ratio: int):
        ...
        self.num_resets = int(self.num_envs // reset_ratio)
    ...
    def step(self, rng, state, action, params=None):
        ...
        rng, _rng = jax.random.split(rng)
        rngs = jax.random.split(_rng, int(self.num_resets))
