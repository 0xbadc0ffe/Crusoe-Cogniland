...
```bash
python scripts/train_ppo_bridge_tunnel.py --config models/bridge_tunnel/natural_centergoal3.yaml \
...
```bash
python scripts/eval_bridge_tunnel_agent.py  --checkpoint models/bridge_tunnel/natural_centergoal3.pt --n-maps 8
python scripts/bridge_tunnel_traj_grid.py   --checkpoint models/bridge_tunnel/natural_centergoal3.pt --n-maps 6 --n-traj 200
```
...
```bash
python scripts/viz_dreamer_bridge_tunnel_traj.py    --checkpoint models/bridge_tunnel/dreamer_natural_categorical/checkpoints/step_1000000
python scripts/viz_dreamer_bridge_tunnel_imagine.py --checkpoint models/bridge_tunnel/dreamer_natural_categorical/checkpoints/step_1000000
```
