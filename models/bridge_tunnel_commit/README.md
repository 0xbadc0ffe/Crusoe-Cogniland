...
Reproduce: `python scripts/train_ppo_bridge_tunnel_commit.py --config models/bridge_tunnel_commit/ppo_commit_onehot.yaml`
Evaluate:  `python scripts/eval_bridge_tunnel_commit_ppo.py --checkpoint models/bridge_tunnel_commit/ppo_commit_onehot.pt`
